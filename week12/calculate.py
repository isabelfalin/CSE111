...
def populate_main_window(frm_main):
    ...
    Return: nothing
    """
    # Create a label that displays "radius of circle:"
    lbl_radius = Label(frm_main, text="Radius of Circle:")
    ...
    lbl_title = Label(frm_main, text="Area:")
    ...
    lbl_title.grid(     row=1, column=0, padx=(30,3), pady=3)
    lbl_area.grid(      row=1, column=1, ipadx=50,  columnspan=2)
    ...
    def calculate(event):
        ...
        try:
            ...
            # entry box, clear the area of a circle result
